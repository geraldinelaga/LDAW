...
const resultado = buscarPublicacionPorTitulo(publicaciones, "BUSCO COMPAÑERO PROYECTO");

console.log(resultado);

const resultado2 = buscarPublicacionPorTitulo(publicaciones, "No existe este titulo");
